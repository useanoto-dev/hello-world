-- Atualizar trigger para baixar estoque quando pedido é ACEITO (em preparação)
...
DROP TRIGGER IF EXISTS deduct_inventory_on_order_accepted ON public.orders;

CREATE TRIGGER deduct_inventory_on_order_accepted
