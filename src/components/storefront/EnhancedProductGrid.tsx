// Enhanced Product Grid with favorites, virtual scroll for large lists, and improved UI
    ...
    return (
      <div className="p-8 text-center">
        ...
        <p className="text-gray-500 text-sm">
          {filterFavoritesOnly ? "Adicione produtos aos favoritos" : "Tente outra categoria"}
        </p>
      </div>
    );
  }
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  {isLowStock && !isOutOfStock && (
                    <div className="absolute bottom-8 left-2 flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold bg-amber-500 text-white shadow-sm animate-pulse">
