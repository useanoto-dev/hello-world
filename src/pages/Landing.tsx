      ...
      <section id="preços" className="px-4 py-16 sm:py-20 relative" style={{ background: `linear-gradient(180deg, transparent 0%, ${COLORS.primaryLight} 8%, ${COLORS.primaryLight} 92%, transparent 100%)` }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Plano Mensal */}
            <AnimatedCard>
              <div className="rounded-3xl p-6 h-full relative overflow-hidden" style={{ backgroundColor: "#fff", boxShadow: "0 4px 24px rgba(0,0,0,0.08)", border: `1px solid ${COLORS.border}` }}>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-base font-semibold" style={{ color: COLORS.foreground }}>Mensal</h3>
                  <span className="text-xs px-2 py-1 rounded-full" style={{ backgroundColor: COLORS.backgroundAlt, color: COLORS.muted }}>Flexível</span>
                </div>
                <div className="mt-2">
                  ...
                  <span className="text-sm ml-1" style={{ color: COLORS.muted }}>/mês</span>
                </div>
                <p className="mt-2 text-xs" style={{ color: COLORS.muted }}>Cobrança mensal, sem compromisso</p>
                ...
                <Button variant="outline" size="lg" className="w-full mt-6 rounded-full text-sm font-semibold h-12" onClick={() => setShowSignupModal(true)}
            ...
            <AnimatedCard delay={0.1}>
              <div className="rounded-3xl p-6 relative h-full overflow-hidden" style={{ backgroundColor: COLORS.foreground, boxShadow: "0 8px 40px rgba(0,0,0,0.25)" }}>
                {/* Badge Mais Escolhido */}
                <div className="absolute -top-0 left-1/2 -translate-x-1/2 px-4 py-1.5 rounded-b-xl text-[10px] font-bold uppercase tracking-wider"
                  style={{ backgroundColor: COLORS.primary, color: COLORS.foreground }}>
                  ⭐ Mais Escolhido
                </div>
                
                <div className="flex items-center justify-between mb-4 mt-4">
                  <h3 className="text-base font-semibold text-white">Anual</h3>
                  <span className="text-xs px-3 py-1 rounded-full font-semibold" style={{ backgroundColor: COLORS.success, color: "#fff" }}>
                    Economize R$ 442,80
                  </span>
                </div>
                
                <div className="mt-2">
                  <span className="text-sm line-through mr-2" style={{ color: "rgba(255,255,255,0.5)" }}>R$ 179,90</span>
                  <span className="text-5xl font-bold text-white">R$ 143</span>
                  <span className="text-lg" style={{ color: "rgba(255,255,255,0.7)" }}>,00</span>
                  <span className="text-sm ml-1" style={{ color: "rgba(255,255,255,0.7)" }}>/mês</span>
                </div>
                
                <div className="mt-3 p-3 rounded-xl" style={{ backgroundColor: "rgba(255,255,255,0.1)" }}>
                  <p className="text-xs text-white">
                    <span className="font-semibold">Total anual:</span> R$ 1.716,00
                    <span className="ml-2 text-[10px]" style={{ color: COLORS.primary }}>• 12x de R$ 143,00</span>
                  </p>
                </div>
                ...
                <ul className="space-y-3">
                  {["Tudo do plano mensal", "Suporte prioritário 24h", "Consultoria de lançamento", "Cardápio com tema premium", "Relatórios avançados", "WhatsApp API integrada"].map(item => (
                    <li key={item} className="flex items-center gap-2.5">
                      <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: COLORS.primary }}>
                ...
                <Button size="lg" className="w-full mt-6 rounded-full text-sm font-semibold h-12 transition-transform hover:scale-[1.02]" onClick={() => setShowSignupModal(true)}
                  style={{ backgroundColor: COLORS.primary, color: COLORS.foreground }}>
                  Começar 7 dias grátis
                </Button>
          ...
          {/* Trust badges */}
          <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-xs" style={{ color: COLORS.muted }}>
