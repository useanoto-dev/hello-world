...
const PIZZA_TEMPLATES = [
  { 
    ...
    defaultTitle: "Personalize sua pizza ✨",
    defaultDescription: "Escolha massa, borda e adicionais",
  ...
  { 
    ...
    defaultTitle: "Que tal uma borda especial? 🧀",
    defaultDescription: "Deixe sua pizza ainda mais saborosa!",
  ...
  { 
    ...
    defaultTitle: "Escolha sua massa 🥖",
    defaultDescription: "Tradicional, integral, sem glúten e mais!",
    defaultButtonText: "Escolher Massa",
    defaultButtonColor: "#a855f7",
    defaultSecondaryText: "Tradicional",
    defaultIcon: "🥖",
    contentType: "doughs",
  },
  { 
